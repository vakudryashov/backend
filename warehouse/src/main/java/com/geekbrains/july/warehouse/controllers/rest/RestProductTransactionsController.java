...
public class RestProductTransactionsController {
    private ProductTransactionService productTransactionService;
    private ProductsService productsService;

    @Autowired
    public RestProductTransactionsController(ProductTransactionService productTransactionService, ProductsService productsService) {
